...
//       if(targetLetter.equals(review.substring(i, i + 1))){
//         // int astrisk = i;
//         int space = review.indexOf(" ", i);

//         String word = review.substring(i, space + 1);
//         finalReview = review.replace(word, randomAdjective());
//       }
//     }
//     return finalReview;
//   }
...
//     String leftWord = content;

//     while (leftWord.length() > 0){
//       int spaceOne = leftWord.indexOf (" ");
//       // int spaceTwo = leftWord.indexOf (" ", spaceOne+1);
      
//       String word;
//       if (spaceOne > -1) {
//         word = leftWord.substring(0, spaceOne);
//         leftWord = leftWord.substring(spaceOne+1);
//       } else {
//         word = leftWord;
//         leftWord = "";
//       }
